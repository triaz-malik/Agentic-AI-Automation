# -*- coding: utf-8 -*-
"""
hikmah-signal/main.py
Full pipeline for HIKMAH Signal.
...
PROJECT      = "hikmah-signal"
PRODUCT_NAME = "HIKMAH Signal"
DB_PATH      = os.getenv("DB_PATH",      "telecom_news.db")
OUTPUT_DIR   = os.getenv("OUTPUT_DIR",   "output")
TEMPLATE_DIR = os.getenv("TEMPLATE_DIR", "templates")
TEMPLATE     = os.getenv("TEMPLATE_FILE", "hikmah_signal.html.j2")
