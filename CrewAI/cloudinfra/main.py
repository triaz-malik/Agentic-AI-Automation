# -*- coding: utf-8 -*-
"""
hikmah-cloudinfra/main.py
Full pipeline for HIKMAH CloudInfra.
...
PROJECT      = "hikmah-cloudinfra"
PRODUCT_NAME = "HIKMAH CloudInfra"
DB_PATH      = os.getenv("DB_PATH",      "cloudinfra_news.db")
OUTPUT_DIR   = os.getenv("OUTPUT_DIR",   "output")
TEMPLATE_DIR = os.getenv("TEMPLATE_DIR", "templates")
TEMPLATE     = os.getenv("TEMPLATE_FILE", "hikmah_cloudinfra.html.j2")
