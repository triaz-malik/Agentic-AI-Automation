# -*- coding: utf-8 -*-
"""
hikmah-intelligence/main.py
Full pipeline for HIKMAH Intelligence.
...
PROJECT      = "hikmah-intelligence"
PRODUCT_NAME = "HIKMAH Intelligence"
DB_PATH      = os.getenv("DB_PATH",      "ai_news.db")
OUTPUT_DIR   = os.getenv("OUTPUT_DIR",   "output")
TEMPLATE_DIR = os.getenv("TEMPLATE_DIR", "templates")
TEMPLATE     = os.getenv("TEMPLATE_FILE", "hikmah_intelligence.html.j2")
