# -*- coding: utf-8 -*-
"""
hikmah-dataarch/main.py
Full pipeline for HIKMAH DataArch.
...
PROJECT      = "hikmah-dataarch"
PRODUCT_NAME = "HIKMAH DataArch"
DB_PATH      = os.getenv("DB_PATH",      "dataarch_news.db")
OUTPUT_DIR   = os.getenv("OUTPUT_DIR",   "output")
TEMPLATE_DIR = os.getenv("TEMPLATE_DIR", "templates")
TEMPLATE     = os.getenv("TEMPLATE_FILE", "hikmah_dataarch.html.j2")
